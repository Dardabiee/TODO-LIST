...
<div class="container">
  ...
  <path d="M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1z"/>
    ...
    <div class="card shadow bg-body-tertiary rounded mb-4 mt-5">
      <div class="card-body">
        <h3 class="judul text-primary">PUT YOUR NOTE HERE!</h3>
        <form class="d-flex" action="insert.php" method="post">
          <input class="form-control me-2" name="title_note" placeholder="TITLE...">
          <input class="form-control me-2" name="note_note" placeholder="KLIK...">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <a href="update.php?edit=<?php echo $result['id_note'];?>" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
